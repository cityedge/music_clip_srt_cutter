# Music Clip & SRT Cutter for Short Movie v1.0.5
...
- The loading-status message area also accepts the same file drops
...
- Safe duration limit, default `179.700` seconds
